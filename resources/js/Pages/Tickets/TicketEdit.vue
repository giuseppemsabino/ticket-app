...
const commentForm = useForm({
  content: "",
  user_visibility: props.user_visibility || false,
});
          ...
          <form @submit.prevent="submitComment">
            ...
            <div class="mb-3">
              ...
              <div class="form-check">
                <input class="form-check-input" type="checkbox" id="userVisibility"
                  v-model="commentForm.user_visibility" />
                <label class="form-check-label " for="userVisibility">
                  <i class="fa-solid fa-eye text-primary"></i> rendi il commento visibile
                  all'utente
                </label>
              </div>
            </div>
          ...
          " class="comments-container">
            <div v-for="comment in props.ticket.comments" :key="comment.id"
              ...
              <div class="d-flex justify-content-between align-items-center mt-2">
                ...
                <small v-if="comment.user_visibility">
