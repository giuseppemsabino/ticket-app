...
const commentForm = useForm({
    ...
    user_visibility: props.user_visibility || false, // visibilità del commento (default false)
});
        ...
        <div class="container mt-5">
            ...
            <div class="card shadow mb-4">
                <div class="card-header bg-light py-3">
                    <h4 class="mb-0">
                        <i class="fas fa-clipboard-list me-2"></i>Dettagli
                ...
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <div
                            class="p-3 border-start border-primary border-3 bg-light rounded"
                        >
                            <p class="fs-5 mb-0">
                    ...
                    <div v-if="props.ticket.u_images" class="mb-4">
                        ...
                        <div class="text-center p-3 border rounded bg-light">
                            <a
                                :href="`/storage/${ticket.u_images}`"
                                target="_blank"
                            >
                                <img
                                    :src="`/storage/${ticket.u_images}`"
                                    alt="Ticket image"
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label">
                                    <i
                                        class="fas fa-project-diagram me-2 text-primary"
                                    ></i
                                    >Progetto
                                </label>
                                <select
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label">
                                    <i
                                        class="fas fa-tasks me-2 text-primary"
                                    ></i
                                    >Stato
                                </label>
                                <select
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label">
                                    <i
                                        class="fas fa-user-cog me-2 text-primary"
                                    ></i
                                    >Assegnato a
                                </label>
                                <select
            ...
            <div class="card shadow mt-4 mb-4">
                <div class="card-header bg-light py-3">
                    <h4 class="mb-0">
                        <i class="fas fa-comment-dots me-2"></i>Aggiungi
                        Commento
                    </h4>
                </div>
                <div class="card-body">
                    <form @submit.prevent="submitComment">
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input
                                    ...
                                    type="checkbox"
                                    id="userVisibility"
                                    v-model="commentForm.user_visibility"
                                />
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            >
                                <i class="fas fa-paper-plane me-2"></i>Aggiungi
                                Commento
                            </PrimaryButton>
                        </div>
                    </form>
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    ...
                    >
                        ...
                        >
                            <div class="d-flex align-items-center mb-2">
                                <i
                                    class="fas fa-user-circle me-2 text-primary fs-5"
                                ></i>
                    ...
                    <div v-else class="text-center py-4">
                        <i
                            class="far fa-comment-dots text-muted mb-3"
